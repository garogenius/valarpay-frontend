...
const ReceiptContent = () => {
  return (
    <div className="w-full min-h-full flex flex-col ">
      <ReceiptBackHeader />
      <div className="w-full h-full bg-dark-primary dark:bg-bg-1100 mt-4 mb-8 py-8 sm:py-10 px-5 md:px-10 flex flex-col items-center justify-center gap-8 md:gap-10 rounded-xl">
